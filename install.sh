...
echo ""
if [ "$install_claude" = true ]; then
  echo "Claude Code: /archflow-init, /archflow-explore, /archflow-prd, /archflow-design, /archflow-phase-design, /archflow-phase-impl, /archflow-status"
fi
if [ "$install_codex" = true ]; then
  echo 'Codex: $archflow-init, $archflow-explore, $archflow-prd, $archflow-design, $archflow-phase-design, $archflow-phase-impl, $archflow-status'
