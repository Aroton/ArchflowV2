...
describe("schema registry invariants", () => {
  it("SCHEMA_IDS holds 46 entries in exact bijection with the schema directory", () => {
    expect(Object.keys(SCHEMA_IDS)).toHaveLength(46);
    expect(new Set(Object.values(SCHEMA_IDS)).size).toBe(46);
    expect(schemaFileNames()).toHaveLength(46);
