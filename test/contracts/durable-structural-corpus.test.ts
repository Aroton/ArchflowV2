...
const EXEMPT_ARRAY_SUBSCHEMAS: readonly string[] = [
  ...
  "task-state/$defs/configRoles/properties/counter-reviewer/anyOf/1",
  "task-state/$defs/configRoles/properties/counter-reviewers",
  "task-state/$defs/configSnapshot/properties/implementation/properties/cost_priority",
  "task-state/$defs/configSnapshot/properties/implementation/properties/enabled_profiles",
...
describe("absence is omission except in contracts that explicitly classify absence", () => {
  it("declares null only for automation observations, PlainJson data, and the autonomous settlement match", () => {
    ...
    expect(offenders).toStrictEqual([
      ...
      "automation-status-v3.schema.json",
      "automation-status-v3.schema.json/oneOf/0/properties/state_revision/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/0/properties/progress/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/1/properties/state_revision/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/1/properties/progress/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/2/properties/state_revision/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/2/properties/progress/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/3/properties/state_revision/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/3/properties/progress/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/4/properties/state_revision/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/4/properties/position/type",
      "automation-status-v3.schema.json/oneOf/4/properties/progress/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/5/properties/state_revision/anyOf/1/type",
      "automation-status-v3.schema.json/oneOf/5/properties/progress/anyOf/1/type",
