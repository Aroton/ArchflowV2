...
async function main() {
  ...
  try {
    ...
    passed.push("bundle-origin-alias");
    ...
    passed.push("adjacent-map-expectation");
    ...
    passed.push("transaction-recovery");
