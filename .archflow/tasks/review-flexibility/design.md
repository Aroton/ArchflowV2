...
- The fallback only retries and accepts; it never rewrites recorded values. New writes always use the new composition, so tasks naturally converge as they transact.
