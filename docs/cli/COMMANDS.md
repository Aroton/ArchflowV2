...
**Explored:** 2026-09-12 · **Commit:** `edae9c7` · **Covers:** `src/local/`, `src/contracts/automation-status.ts`, `src/state/status.ts`, `src/state/request-composition.ts`, `src/init/`, `install.sh`
