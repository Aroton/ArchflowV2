...
import {
  ...
  pendingValidationOverrideV1Schema,
  planningRestartHumanProvenanceV1Schema,
  planningRestartRecordV1Schema,
  ruleSettlementConclusionV1Schema,
  ruleSettlementV1Schema,
  reviewPushThroughRecordV1Schema,
  stepStatusV1Schema,
  ...
  taskStateV1Schema,
  validationOverrideRecordV1Schema,
  waiverRefV1Schema,
  ...
  documents: [
    ...
    },
    {
      ...
      defs: {
        ...
        pendingValidationOverride: pendingValidationOverrideV1Schema,
        ...
        validationOverrideRecord: validationOverrideRecordV1Schema,
        reviewPushThroughRecord: reviewPushThroughRecordV1Schema,
        ruleSettlementConclusion: ruleSettlementConclusionV1Schema,
        ruleSettlement: ruleSettlementV1Schema,
