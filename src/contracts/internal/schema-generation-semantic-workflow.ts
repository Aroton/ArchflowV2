...
export const semanticWorkflowSchemaGroup: SchemaGenerationGroup = {
  ...
  documents: [{
    ...
    defs: {
      ...
      publicFindingV2: publicFindingV2Schema,
      legacyPublicFindingV1: legacyPublicFindingV1Schema,
      publicReviewRound: publicReviewRoundV1Schema,
      publicReviewRoundV2: publicReviewRoundV2Schema,
      legacyPublicReviewRoundV1: legacyPublicReviewRoundV1Schema,
      publicValidationOverrideAudit: publicValidationOverrideAuditV1Schema,
      publicReviewPushThroughAudit: publicReviewPushThroughAuditV1Schema,
      taxonomyDenialRates: taxonomyDenialRatesV1Schema,
