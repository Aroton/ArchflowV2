...
export const PROJECT_ERROR_DEFINITIONS = Object.freeze({
  ...
  GATE_ACTIVE: defineError("gate", false, PROJECT_PARAMETER_SCHEMAS.GATE_ACTIVE, "resolve-recorded-gate", "project"), GATE_DECISION_INVALID: defineError("gate", false, PROJECT_PARAMETER_SCHEMAS.GATE_DECISION_INVALID, "record-valid-gate-decision", "project"), GATE_CANCELLED: defineError("gate", false, PROJECT_PARAMETER_SCHEMAS.GATE_CANCELLED, "restart-gate-flow", "project"), GATE_SUPERSEDED: defineError("gate", false, PROJECT_PARAMETER_SCHEMAS.GATE_SUPERSEDED, "retry-with-superseding-subject", "project"),
