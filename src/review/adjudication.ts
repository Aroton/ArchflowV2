...
export function policyReviewFacts(
  ...
  if (review.schema_version === "3" || isFeedbackReview(review)) {
    ...
    const alignment = isFeedbackReview(review) ? [] : review.upstream_alignment ?? [];
    return Object.freeze({
      ...
      alignment: Object.freeze({
        source: isFeedbackReview(review) || review.upstream_alignment === undefined ? "not-reviewed" : "review-v3",
